...
namespace ICHI_CORE.Controllers.MasterController
{
  ...
  public class TrademarkController : BaseController<Trademark>
  {
    private readonly ITrademarkService _supplierService;
    public TrademarkController(PcsApiContext context, ITrademarkService supplierService) : base(context)
    {
    ...
    [HttpPost("Update-Trademark")]
    public async Task<ApiResponse<Trademark>> UpdateSupplỉer([FromBody] Trademark supplier)
    {
      ApiResponse<Trademark> result;
      string strMessage = "";
      try
