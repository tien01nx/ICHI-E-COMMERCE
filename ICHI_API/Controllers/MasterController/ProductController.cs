...
namespace ICHI_CORE.Controllers.MasterController
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<ApiResponse<List<ProductDTO>>> Search(string productName)
        {
            ApiResponse<List<ProductDTO>> result;
            string strMessage = "";
            try
            {
                var data = _productService.Search(productName, out strMessage);
                result = new ApiResponse<List<ProductDTO>>(System.Net.HttpStatusCode.OK, strMessage, data);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("ProductTopFive")]
        public async Task<ApiResponse<List<ProductDTO>>> ProductTopFive(string dateTime)
        {
            ApiResponse<List<ProductDTO>> result;
            string strMessage = "";
            try
            {
                var data = _productService.ProductTopFive(dateTime, out strMessage);
                result = new ApiResponse<List<ProductDTO>>(System.Net.HttpStatusCode.OK, strMessage, data);
                return result;
            }
            catch (Exception ex)
