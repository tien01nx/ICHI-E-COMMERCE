    ...
    public partial class db : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Dụng cụ viết", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3904), false, null, null, "Mô tả về dụng cụ viết", 0 },
                    { 2, 1, "Giấy và sổ tay", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3907), false, null, null, "Mô tả về giấy và sổ tay", 0 },
                    { 3, 2, "Bút bi", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3910), false, null, null, "Mô tả về bút bi", 1 },
                    { 4, 2, "Bút mực", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3912), false, null, null, "Mô tả về bút mực", 1 },
                    { 5, 2, "Bút chì", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3914), false, null, null, "Mô tả về bút chì", 1 },
                    { 6, 2, "Giấy in", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3917), false, null, null, "Mô tả về giấy in", 2 },
                    { 7, 2, "Sổ tay", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3920), false, null, null, "Mô tả về sổ tay", 2 },
                    { 8, 2, "Sổ bìa cứng", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3922), false, null, null, "Mô tả về sổ bìa cứng", 2 },
                    { 9, 2, "Sổ bìa mềm", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3924), false, null, null, "Mô tả về sổ bìa mềm", 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3653), "Quản trị viên", null, null, "ADMIN" },
                    { 2, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3656), "Nhân viên", null, null, "EMPLOYEE" },
                    { 3, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3659), "Người dùng", null, null, "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Đường ABC, Quận XYZ, Thành phố HCM", "0123456789", "Ngân hàng ABC, Chi nhánh XYZ", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3948), "info@supplierA.com", null, null, "Thông tin chi tiết về nhà cung cấp A", "0123456789", "Nhà cung cấp A", "TAX001", true, false },
                    { 2, "456 Đường XYZ, Quận ABC, Thành phố HCM", "9876543210", "Ngân hàng XYZ, Chi nhánh ABC", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3952), "info2@supplier.com", null, null, "Thông tin chi tiết về nhà cung cấp B", "0987654321", "Nhà cung cấp B", "TAX002", true, false },
                    { 3, "789 Đường LMN, Quận PQR, Thành phố HCM", "7412589630", "Ngân hàng LMN, Chi nhánh PQR", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3955), "info3@gmail.com", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3953), "Thông tin chi tiết về nhà cung cấp C", "0369852147", "Nhà cung cấp C", "TAX003", true, false },
                    { 4, "789 Đường LMN, Quận PQR, Thành phố HCM", "7412589630", "Ngân hàng LMN, Chi nhánh PQR", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3970), "demo2@gmail.com", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3969), "Thông tin chi tiết về nhà cung cấp D", "0369852147", "Nhà cung cấp D", "TAX004", true, false },
                    { 5, "789 Đường LMN, Quận PQR, Thành phố HCM", "7412589630", "Ngân hàng LMN, Chi nhánh PQR", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3974), "demo2@gmail.com", "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3972), "Thông tin chi tiết về nhà cung cấp E", "0369852147", "Nhà cung cấp E", "TAX005", true, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3994), null, null, "Thương hiệu A" },
                    { 2, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3996), null, null, "Thương hiệu B" },
                    { 3, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3998), null, null, "Thương hiệu C" },
                    { 4, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4000), null, null, "Thương hiệu D" },
                    { 5, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4002), null, null, "Thương hiệu E" },
                    { 6, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4003), null, null, "Thương hiệu F" },
                    { 7, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4005), null, null, "Thương hiệu G" },
                    { 8, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4007), null, null, "Thương hiệu H" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Avatar", "CreateBy", "CreateDate", "Email", "FailedPassAttemptCount", "IsLocked", "ModifiedBy", "ModifiedDate", "Password" },
                values: new object[,]
                {
                    { 1, "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F717761877848073%2F&psig=AOvVaw", "ADMIN", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3810), "tien01nx@gmail.com", 0, false, "ADMIN", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3811), "$2a$11$iIcGb07Q8qC2x3bT2kXe4.7815/izsL8vF9tCLyKrtaCD06.HYF7." },
                    { 2, "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F717761877848073%2F&psig=AOvVaw", "ADMIN", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3814), "diuthanh88@gmail.com", 0, false, "ADMIN", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3815), "$2a$11$iIcGb07Q8qC2x3bT2kXe4.7815/izsL8vF9tCLyKrtaCD06.HYF7." },
                    { 3, "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F717761877848073%2F&psig=AOvVaw", "ADMIN", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3817), "s2family2001bn@gmail.com", 0, false, "ADMIN", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3818), "$2a$11$iIcGb07Q8qC2x3bT2kXe4.7815/izsL8vF9tCLyKrtaCD06.HYF7." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "123 Đường ABC, Quận XYZ, Thành phố HCM", "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F717761877848073%2F&psig=AOvVaw", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3842), "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3844), "kh03@gmail.com", "Khách hàng A", "Nam", null, null, "0123456789", 3, true, false });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Address", "Avatar", "Birthday", "CreateBy", "CreateDate", "Email", "FullName", "Gender", "ModifiedBy", "ModifiedDate", "PhoneNumber", "UserId", "isActive", "isDeleted" },
                values: new object[] { 1, "123 Đường ABC, Quận XYZ, Thành", "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Fpin%2F717761877848073%2F&psig=AOvVaw", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3862), "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(3863), "nhanvien@gmail.com", "Nhân viên A", "Nam", null, null, "0123456789", 2, true, false });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4068), "574854f032ae36fc0d0a57b61f588965.jpg", "\\images\\products\\product-2\\66df2941-a432-4b5f-a1ef-4f07eec2e608.jpg", true, false, false, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4069), 2 },
                    { 3, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4071), "5cb2991cc6a258b7c1cc07105bccaa29.jpg", "\\images\\products\\product-3\\04be0986-90ea-41b4-ac17-153d52f3fe74.jpg", true, false, false, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4072), 3 },
                    { 4, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4074), "3f23c30055381c7e58af80a62ce28fa5.jpg", "\\images\\products\\product-4\\0016eca6-2e6e-44d2-874f-b2deefb97893.jpg", true, false, false, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4075), 4 },
                    { 5, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4077), "Screenshot_3.png", "\\images\\products\\product-5\\ff69973a-bad5-4757-be92-6792b6d4ff9e.png", true, false, false, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4077), 4 },
                    { 6, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4080), "Screenshot_7.png", "\\images\\products\\product-6\\0c3182bd-e13f-4303-b7d7-c69c0616b6b8.png", true, false, false, "Admin", new DateTime(2024, 3, 15, 21, 34, 13, 146, DateTimeKind.Local).AddTicks(4080), 4 }
                });
