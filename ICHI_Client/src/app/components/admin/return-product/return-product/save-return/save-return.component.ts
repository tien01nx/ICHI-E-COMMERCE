...
//   orderCompleted: TrxTransactionVM[] = [];

//   order!: TrxTransactionVM;
...
//       if (
//         error.error ===
//         'QUANTITY_RETURN_PRODUCT_MUST_BE_LESS_THAN_QUANTITY_ORDER'
//       ) {
//         this.toastr.error(
//           'Số lượng đổi trả phải nhỏ hơn số lượng đã mua!',
//           'Thông báo'
//         );
//       }
...
//         this.toastr.error(
//           'Đơn hàng này đang có yêu cầu đổi trả, hãy xử lý trước!'
//         );
//       }
...
//       const productDetailsId = receiptDetails
//         .at(index)
//         .get('productDetailsId')?.value;
//       const indexProductSelected = this.listProductSecondary.findIndex(
//         (x) => x.productDetailsId === productDetailsId
//       );
...
//             (x) => x.productDetailsId === productId
//           );
