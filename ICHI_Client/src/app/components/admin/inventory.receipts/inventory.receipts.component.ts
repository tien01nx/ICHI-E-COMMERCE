...
@Component({
  selector: 'app-inventory.receipts',
  templateUrl: './inventory.receipts.component.html',
  styleUrl: './inventory.receipts.component.css',
})
export class InventoryReceiptsComponent implements OnInit {
  protected readonly Utils = Utils;
  Environment = Environment;
  paginationModel: PaginationDTO<InventoryReceiptsModel> =
  ...
  constructor(
    private title: Title,
    private productService: InventorryReceiptsService,
  ...
  changePageNumber(pageNumber: number): void {
    this.router
      .navigate(['/admin/inventory_receipts'], {
