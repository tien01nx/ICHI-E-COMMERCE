(function (factory) {
  ...
  const newUsersChartsInit = () => {
    const {
      ...
      r = document.querySelector(".echarts-new-users"),
      i = (o) => {
        const t = window.dayjs(o[0].axisValue),
          a = window.dayjs(o[0].axisValue).subtract(1, "month"),
          e = o.map((o, e) => ({
            value: o.value,
            date: e > 0 ? a : t,
            color: o.color,
        ...
        return (
          e.forEach((o, t) => {
            r += `<h6 class="fs-9 text-body-tertiary ${
              t > 0 && "mb-0"
        ...
        series: [
          {
            ...
            areaStyle: {
              color: {
                ...
                y2: 1,
                colorStops: [
                  { offset: 0, color: e(o("info"), 0.2) },
                  { offset: 1, color: e(o("info"), 0) },
                ],
              },
            },
            showSymbol: !1,
  ...
  const newLeadsChartsInit = () => {
    const {
      ...
      r = document.querySelector(".echarts-new-leads"),
      i = (o) => {
        const t = window.dayjs(o[0].axisValue),
          a = window.dayjs(o[0].axisValue).subtract(1, "month"),
          e = o.map((o, e) => ({
  ...
  const addClicksChartInit = () => {
    const {
      ...
      a = document.querySelector(".echart-add-clicks-chart"),
      r = e(11),
      l = [2e3, 2250, 1070, 1200, 1e3, 1450, 3100, 2900, 1800, 1450, 1700],
      n = [1100, 1200, 2700, 1700, 2100, 2e3, 2300, 1200, 2600, 2900, 1900],
      s = (o) => {
        const t = window.dayjs(o[0].axisValue),
        ...
        return (
          i.forEach((o, t) => {
            a += `<h6 class="fs-9 text-body-tertiary ${
              t > 0 && "mb-0"
            }"><span class="fas fa-circle me-2" style="color:${
              o.color
            }"></span>\n      ${o.date.format("MMM DD")} : ${
        ...
        xAxis: [
          {
            ...
            axisLine: { show: !0, lineStyle: { color: o("tertiary-bg") } },
        ...
        series: [
          {
            ...
            type: "line",
            data: n,
            lineStyle: { type: "line", width: 3, color: o("info-lighter") },
            showSymbol: !1,
            symbol: "emptyCircle",
            symbolSize: 6,
            itemStyle: { color: o("info-lighter"), borderWidth: 3 },
          },
          {
            name: "d",
            type: "line",
            ...
            symbol: "emptyCircle",
            symbolSize: 6,
            itemStyle: { color: o("primary"), borderWidth: 3 },
            lineStyle: { type: "line", width: 3, color: o("primary") },
          },
        ],
        grid: {
          right: 2,
  ...
  const echartsLeadConversiontInit = () => {
    const {
      ...
      t = document.querySelector(".echart-lead-conversion"),
      a = i(4);
    if (t) {
      const i = r(t, "echarts"),
        l = echarts.init(t);
      echartSetOption(
        ...
        () => ({
          ...
          tooltip: {
            ...
            formatter: (e) =>
              ((e) => {
                ...
                return (
                  e.forEach((e) => {
                    r += `<h6 class="fs-9 text-body-tertiary mb-0"><span class="fas fa-circle me-2" style="color:${e.color}"></span>\n      ${e.axisValue} : ${e.value}\n    </h6>`;
                  }),
                  `<div class='ms-1'>\n              ${r}\n            </div>`
                );
              })(e),
          ...
          series: {
            ...
            barWidth: "20px",
            showBackground: !0,
            backgroundStyle: { borderRadius: [4, 0, 0, 4] },
            data: [
              {
                value: 1060,
                itemStyle: {
                  color: o(e("success-lighter"), e("success-dark")),
                  borderRadius: [4, 0, 0, 4],
                },
                emphasis: {
                  itemStyle: {
                    color: o(e("success-light"), e("success-dark")),
                  },
                  label: {
                    formatter: () => "{b| 53% }",
                    rich: { b: { color: e("white") } },
                  },
                },
                label: {
                  show: !0,
                  ...
                  rich: {
                    b: {
                      color: o(e("success-dark"), e("success-subtle")),
                      fontWeight: 500,
                      padding: [0, 5, 0, 0],
                    },
                  },
              ...
              },
              {
                value: 1200,
                itemStyle: {
                  color: o(e("info-lighter"), e("info-dark")),
                  borderRadius: [4, 0, 0, 4],
                },
                emphasis: {
                  itemStyle: { color: o(e("info-light"), e("info-dark")) },
                  label: {
                    formatter: () => "{b| 60% }",
                    rich: { b: { color: e("white") } },
                  },
                ...
                label: {
                  ...
                  rich: {
                    b: {
                      color: o(e("info-dark"), e("info-bg-subtle")),
                      fontWeight: 500,
                      padding: [0, 5, 0, 0],
                    },
                  },
              ...
              },
              {
                value: 1600,
                itemStyle: {
                  color: o(e("primary-lighter"), e("primary-dark")),
                  borderRadius: [4, 0, 0, 4],
                },
                emphasis: {
                  itemStyle: {
                    color: o(e("primary-light"), e("primary-dark")),
                  },
                  label: {
                    formatter: () => "{b| 80% }",
                    rich: { b: { color: e("white") } },
                ...
                label: {
                  ...
                  rich: {
                    b: {
                      color: o(e("primary-dark"), e("primary-bg-subtle")),
                      fontWeight: 500,
                      padding: [0, 5, 0, 0],
                    },
                  },
              ...
              },
              {
                value: 1800,
                itemStyle: {
                  color: o(e("warning-lighter"), e("warning-dark")),
                  borderRadius: [4, 0, 0, 4],
                },
                emphasis: {
                  itemStyle: {
                    color: o(e("warning-light"), e("warning-dark")),
                  },
                  label: {
                    formatter: () => "{b| 90% }",
                    rich: { b: { color: e("white") } },
                ...
                label: {
                  ...
                  rich: {
                    b: {
                      color: o(e("warning-dark"), e("warning-bg-subtle")),
                      fontWeight: 500,
                      padding: [0, 5, 0, 0],
                    },
                  },
              ...
              },
              {
                value: 2e3,
                itemStyle: {
                  color: o(e("danger-lighter"), e("danger-dark")),
                  borderRadius: [4, 0, 0, 4],
                },
                emphasis: {
                  itemStyle: { color: o(e("danger-light"), e("danger-dark")) },
                  label: {
                    formatter: () => "{a|100%}",
                    rich: { a: { color: e("white") } },
                  },
                },
                label: {
                  show: !0,
                  ...
                  rich: {
                    a: {
                      color: o(e("danger-dark"), e("danger-subtle")),
                      fontWeight: 500,
                    },
                  },
                },
        ...
        {
          xs: { yAxis: { show: !1 }, grid: { left: 0 } },
          sm: { yAxis: { show: !0 }, grid: { left: 100 } },
        }
      );
    }
  };
