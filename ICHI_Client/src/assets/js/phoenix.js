(function (global, factory) {
        ...
        c?.addEventListener("click", () => {
          ...
          (e.value = n.innerHTML),
            ...
            (o.querySelector(".toast-body").innerHTML =
              "<code class='text-body-quaternary'>Code has been copied to clipboard.</code>"),
            t.show();
        });
    });
  };
  ...
  const orders = [
      ...
      },
      {
        ...
        date: "30/04/2023",
        address:
          "Josef Stravinsky, 1 Infinite Loop, Cupertino, California 90210",
      ...
      },
      {
        ...
        date: "30/04/2023",
        address:
          "Katerina Karenin, 1 Infinite Loop, Cupertino, California 90210",
      ...
      },
      {
        ...
        date: "26/04/2023",
        address:
          "Trace Farrell, 431 Steuber Mews Apt. 252 Germanland, AK 25882",
        deliveryType: "Free Shipping",
        status: "Completed",
        badge: { type: "success", icon: "fas fa-check" },
        amount: "$70",
      ...
      },
      {
        ...
        date: "24/04/2023",
        address:
          "Brenda Watsica, 9198 O'Kon Harbors Morarborough, IA 75409-7383",
        deliveryType: "Free Shipping",
        status: "Completed",
        badge: { type: "success", icon: "fas fa-check" },
        amount: "$89",
            ...
            l.filter(
              (d) =>
                ...
                d
                  .values()
                  [e].toLowerCase()
                  .includes(a.target.value.toLowerCase())
            );
          });
        }
      }
        ...
        return (
          ...
          `<div>\n              <p class='mb-2 text-body-tertiary'>\n                ${
            window.dayjs(t[0].axisValue).isValid()
              ? window.dayjs(t[0].axisValue).format("DD MMM, YYYY")
              : t[0].axisValue
          }\n              </p>\n              ${e}\n            </div>`
        );
      },
  ...
  const chatInit = () => {
    ...
    if (d) {
      const t = d.querySelectorAll("[data-bs-toggle='tab']"),
        a = new window.List(i, { valueNames: ["read", "unreadItem"] }),
  ...
  const choicesInit = () => {
    ...
    if (window.Choices) {
      document.querySelectorAll("[data-choices]").forEach((t) => {
        const i = e(t, "options"),
          s = new window.Choices(t, { itemSelectText: "", addItems: !0, ...i });
        return (
            ...
            const i = () => {
              e.querySelectorAll(".choices").forEach((e) => {
                ...
                e.querySelector("[required]") &&
                  ...
                  i &&
                    (e.getElementsByTagName("option").length
                      ? (e.classList.remove("invalid"),
                        e.classList.add("valid"))
                      : (e.classList.remove("valid"),
                        e.classList.add("invalid"))));
    ...
    if (l.length && window.google) {
        ...
        s = {
          SnazzyCustomLight: [
            ...
            },
            {
              featureType: "road.arterial",
              elementType: "geometry",
              stylers: [{ visibility: "on" }, { color: "#eff2f6" }],
            },
            {
              featureType: "road.arterial",
              elementType: "labels.text.fill",
              stylers: [{ visibility: "on" }, { color: "#9fa6bc" }],
            },
            {
              featureType: "road.arterial",
              elementType: "labels.text.stroke",
          ...
          SnazzyCustomDark: [
            ...
            },
            {
              featureType: "road.arterial",
              elementType: "geometry",
              stylers: [{ visibility: "on" }, { color: "#141824" }],
            },
            {
              featureType: "road.arterial",
              elementType: "labels.text.fill",
              stylers: [{ visibility: "on" }, { color: "#525b75" }],
            },
            {
              featureType: "road.arterial",
              elementType: "labels.text.stroke",
            ...
            },
            {
              featureType: "road.local",
              elementType: "labels.text.fill",
              stylers: [{ visibility: "on" }, { color: "#67718A" }],
            },
            {
              featureType: "road.local",
              elementType: "labels.text.stroke",
      ...
      l.forEach((l) => {
        ...
        if ("streetview" === e(l, "phoenixTheme")) {
          const t = e(l, "pov"),
            i = {
              position: { lat: Number(o[0]), lng: Number(o[1]) },
              pov: t,
              zoom: a,
            ...
            t.addEventListener(
              ...
              ({ detail: { control: e, value: t } }) => {
                "phoenixTheme" === e &&
                  f.set(
                    "styles",
                    "dark" === t ? s.SnazzyCustomDark : s.SnazzyCustomLight
                  );
              }
            );
      });
      ...
      if (window.List) {
        ...
        t.length &&
          t.forEach((t) => {
            ...
            if (a) {
              window.phoenix.BulkSelect.getInstance(a).attachRowNodes(
                g.items.map((e) =>
                  e.elm.querySelector("[data-bulk-select-row]")
                )
              ),
  ...
  const navbarShadowOnScrollInit = () => {
    ...
    a &&
      (window.onscroll = () => {
        window.scrollY > 300
          ? a.classList.add("navbar-shadow")
          : a.classList.remove("navbar-shadow");
      });
  };
            ...
            t(() => {
              ...
              new Swiper(n, {
                ...
                navigation: {
                  ...
                  nextEl: p?.querySelector(".swiper-button-next1"),
                  prevEl: p?.querySelector(".swiper-button-prev1"),

                  nextEl: p?.querySelector(".swiper-button-next2"),
                  prevEl: p?.querySelector(".swiper-button-prev2"),
                },
                thumbs: { swiper: l },
              });
          },
      ...
      t.forEach((t) => {
        ...
        new window.Swiper(r, {
          ...
          navigation: {
            ...
            nextEl: o?.querySelector(".swiper-button-next1"),
            prevEl: o?.querySelector(".swiper-button-prev1"),
            nextEl: o?.querySelector(".swiper-button-next2"),
            prevEl: o?.querySelector(".swiper-button-prev2"),
          },
          thumbs: { swiper: s },
        });
      });
            ...
            r = merge(
              {
                ...
                setup: (e) => {
                  e.on("focus", () => {
                    document
                      .querySelector(".tox-sidebar-wrap")
                      .classList.add("editor-focused");
                  }),
                    e.on("blur", () => {
                      document
                        .querySelector(".tox-sidebar-wrap")
                        .classList.remove("editor-focused");
                    });
                },
              },
              i
  ...
  const wizardInit = () => {
    ...
    document.querySelectorAll(t).forEach((t) => {
      const m = t.querySelectorAll(a),
        ...
        f = t.querySelector(n),
        g = t.querySelector(o),
        y = new Event(c, { bubbles: !0, cancelable: !0 }),
        z = t.classList.contains(i),
        E = Array.from(m).map((e) =>
          window.bootstrap.Tab.getOrCreateInstance(e)
        );
      let q = 0,
        S = null;
        ...
        e.addEventListener(
          ...
          (t) => (
            ...
            (b &&
              p &&
              (b.value !== p.value
                ? p.setCustomValidity("Invalid field.")
                : p.setCustomValidity("")),
            !e.checkValidity())
              ? (S.preventDefault(), !1)
              : ((q += 1), null)
  ...
  const faqTabInit = () => {
    ...
    e &&
      e.forEach((t) => {
        t.classList.contains("active") &&
          c.forEach((a) => {
            a.classList.contains(t.getAttribute("data-category-filter")) ||
              "all" === t.getAttribute("data-category-filter") ||
              a.classList.add("d-none");
          }),
          t.addEventListener("click", () => {
            c.forEach((a) => {
              "all" === t.getAttribute("data-category-filter")
                ...
                : a.classList.contains(
                    t.getAttribute("data-category-filter")
                  ) || a.classList.add("d-none");
            });
          });
      });
