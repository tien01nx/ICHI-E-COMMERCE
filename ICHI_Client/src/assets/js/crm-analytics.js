(function (factory) {
  ...
  const emailCampaignReportsChartInit = () => {
    const { getColor: t, getData: e, toggleColor: r } = window.phoenix.utils,
      o = document.querySelector(".echart-email-campaign-report"),
      a = (t, e = "MMM DD") => {
        const r = t[1],
          o = `<div class='ms-1'>\n          <h6 class="text-body-tertiary"><span class="fas fa-circle me-1 fs-10" style="color:${
            r.borderColor ? r.borderColor : r.color
          }"></span>\n            ${r.axisValue} : ${
            "object" == typeof r.value ? r.value[1] : r.value
          }\n          </h6>\n        </div>`;
      ...
      echartSetOption(
          ...
          series: [
            ...
            },
            {
              ...
              label: {
                show: !0,
                position: "inside",
                color: r(t("emphasis-color"), t("white")),
                fontWeight: "normal",
                fontSize: "12.8px",
        ...
        }),
        {
          xs: {
            ...
            xAxis: {
              axisLabel: { show: !0, formatter: (t) => `${t.slice(0, 5)}...` },
            },
          },
          sm: {
          ...
          md: {
            series: [{ barWidth: "56px" }],
            xAxis: { axisLabel: { show: !1 } },
          },
          lg: {
            series: [{ barWidth: "64px" }],
            xAxis: {
              axisLabel: { show: !0, formatter: (t) => `${t.slice(0, 11)}` },
            },
          },
        }
      );
          ...
          radar: {
            ...
            splitArea: {
              ...
              areaStyle: {
                shadowBlur: 0.5,
                color: [
                  t(e("body-highlight-bg"), e("body-highlight-bg")),
                  t(e("body-bg"), e("secondary-bg")),
                ],
              },
            },
            axisLine: { show: !0, lineStyle: { color: e("secondary-bg") } },
            name: {
              textStyle: {
              ...
              data: [
                {
                  ...
                  itemStyle: { color: e("primary-light") },
                  areaStyle: { color: r(e("primary-light"), 0.3) },
                },
                {
                  value: [3e3, 1600, 3700, 500, 3700, 3e3, 3200],
                  name: "Online Marketing",
                  areaStyle: { color: r(e("warning-light"), 0.3) },
                  itemStyle: { color: e("warning-light") },
                },
              ],
            },
          ],
  ...
  const salesTrendsChartInit = () => {
    const {
      ...
      a = document.querySelector(".echart-sales-trends"),
      l = (t, e = "MMM DD") => {
        let o = "";
        return (
          t.forEach((t) => {
      ...
      n = o(7),
      s = [2e3, 5700, 3700, 5500, 8e3, 4e3, 5500],
      d = [10500, 9e3, 7e3, 9e3, 10400, 7500, 9300];
    if (a) {
      const o = e(a, "echarts"),
          ...
          },
          {
            ...
            areaStyle: {
              color: {
                ...
                y2: 1,
                colorStops: [
                  { offset: 0, color: i(t("info-light"), 0.2) },
                  { offset: 1, color: i(t("info-light"), 0.2) },
                ],
              },
            },
            data: s,
  ...
  const callCampaignChartInit = () => {
    const {
      ...
      i = document.querySelector(".echart-call-campaign"),
      r = (o, a = "MMM DD") => {
        let t = "";
        return (
          o.forEach((o) => {
            t += `<div class='ms-1'>\n          <h6 class="text-body-tertiary"><span class="fas fa-circle me-1 fs-10" style="color:${
              ...
              "object" == typeof o.value ? o.value[1] : o.value
            }\n          </h6>\n        </div>`;
          }),
          `<div>\n              <p class='mb-2 text-body-tertiary'>\n                ${
            window.dayjs(o[0].axisValue).isValid()
              ? window.dayjs(o[0].axisValue).format("DD MMM, YYYY")
              : o[0].axisValue
          }\n              </p>\n              ${t}\n            </div>`
        );
      },
      l = t(7),
      n = [8e3, 7700, 5900, 10100, 5100, 6e3, 4300];
    if (i) {
      const t = a(i, "echarts"),
          ...
          xAxis: [
            {
              ...
              data: l,
              boundaryGap: !1,
              splitLine: { show: !0, lineStyle: { color: o("secondary-bg") } },
              axisLabel: {
                color: o("body-color"),
                showMaxLabel: !1,
                showMinLabel: !0,
              ...
              axisLine: { lineStyle: { color: o("secondary-bg") } },
              axisTick: !1,
            },
            {
              type: "category",
